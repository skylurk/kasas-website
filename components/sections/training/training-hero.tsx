        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              <Link
                href="https://think.co.ke/flight-simulator/"
                target="_blank"
                rel="noreferrer"
                className="group relative overflow-hidden inline-flex items-center gap-3 h-12 pl-1.5 pr-6 rounded-full bg-sky-500 text-white text-sm font-medium transition-colors duration-500"
              >
                ...
                <span className="relative z-10">Enquire About Training</span>
              </Link>
              ...
              >
                ...
                <span className="relative z-10">View Simulators</span>
              </Link>
            </div>
          </motion.div>
        </AnimatePresence>
